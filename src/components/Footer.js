...
export default function Footer() {
  return (
    ...
    <div className="wrapper ">
      <footer className="p-4 bg-slate-200 dark:bg-slate-500 sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="" className="flex items-center">
                <img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-8" alt=" Logo"></img>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#" className="hover:underline">Coder™</a>. All Rights Reserved.
        </span>
